"""
GDPO RL fine-tuning of a ZINC E1 base against the three structural failure modes.
...
def experiment(e: Experiment) -> None:
    ...
    _, atom_decoder, _, bond_decoder = build_encoders(zref.ATOM_TYPES, zref.BOND_TYPES)
    split = zref.load_reference_split()
