...
# Representations
# ===========================================================================
#: ``Representation`` is defined in :mod:`defog.data.vocabulary` because ChEMBL
#: now declares named representations too. Re-exported here so that
#: ``moses_reference.Representation`` keeps working.
from .vocabulary import Representation  # noqa: E402
